class cfgMagazines
{
	class magazineLimitations
	{
		...
		class Grenade
		{
			magazineArray[] = {"rhs_mag_rgd5","rhs_mag_m67","rhs_mag_rgn","rhs_mag_nspd","rhs_mag_nspn_red","rhs_mag_rdg2_white"};
			limit = 3;
			limtResistance = 3;
		...
		class HE_Rockets
		{
			magazineArray[] = {"rhs_rpg7_OG70V_mag","CUP_M136_M","CUP_SMAW_HEDP_M"};
			limit = 3;
			limtResistance = 3;
